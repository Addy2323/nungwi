...
export default function Storefront({ shopPage = false }: { shopPage?: boolean }) {
      ...
      {shopPage ? <>
        <section className="shop-intro" aria-labelledby="shop-page-title">
          ...
          <div className="shop-intro-content">
            <div><span className="eyebrow">{t('THE NUNGWI SHOP', 'DUKA LA NUNGWI')}</span><h1 id="shop-page-title">{t('Your island essentials.', 'Mahitaji yako ya kisiwani.')}</h1><p>{t('From your first cold drink to your last beach-day snack. Browse everything, find your favourites, and we will bring them to you.', 'Kuanzia kinywaji baridi hadi vitafunio vya ufukweni. Vinjari bidhaa zote, chagua vipendwa vyako, nasi tutakuletea.')}</p></div>
