...
export default function ShopFooter() {
  ...
  return <footer className="shop-footer">
    <div><Link className="brand-logo" href="/">NUNGWI <b>SHOP</b></Link><p>{t('Island essentials, thoughtfully delivered.', 'Mahitaji ya kisiwani, yakifikishwa kwa uangalifu.')}</p><p>Vunjabei Liquor Zanzibar ? Nungwi Shop</p><p>Nungwi & Kendwa · Zanzibar</p></div>
